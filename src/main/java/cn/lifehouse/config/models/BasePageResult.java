package cn.lifehouse.config.models;
...
public class BasePageResult<T> extends BaseResult<T> {
    ...
    public static <T> BasePageResult<T> notAllow() {
        return new BasePageResult<T>(BaseResult.CODE_NOT_ALLOW, "未经许可的用户", null, null);
    }
    ...
    public static <T> BasePageResult<T> parameterError() {
        return new BasePageResult<T>(BaseResult.CODE_PARAM_ERR, "参数解析错误", null, null);
    }
    ...
    public static <T> BasePageResult<T> parameterError(String msg) {
        return new BasePageResult<T>(BaseResult.CODE_PARAM_ERR, msg, null, null);
    }
    ...
    public static <T> BasePageResult<T> serverError() {
        return new BasePageResult<T>(BaseResult.CODE_SERVER_ERR, "服务器异常", null, null);
    }
    ...
    public static <T> BasePageResult<T> serverError(String msg) {
        return new BasePageResult<T>(BaseResult.CODE_SERVER_ERR, msg, null, null);
    }
}
